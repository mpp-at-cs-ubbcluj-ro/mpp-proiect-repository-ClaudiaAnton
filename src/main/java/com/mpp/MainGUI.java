...
import com.mpp.controller.ChatClientCtrl;
...
////            ctrl.init(arbitruService,participantService,probaService,rezultatService);
//
//            stage.setTitle("MPP chat");
//            stage.setScene(new Scene(root));
//            stage.show();
////            Parent fxmlLoader = FXMLLoader.load(getClass().getClassLoader().getResource("login.fxml"));
...
//    }
    ...
    public void start(Stage stage) throws IOException {
        ...
        try {
            clientProps.load(MainGUI.class.getResourceAsStream("/chatclient.properties"));
        ...
        ChatClientCtrl clientCtrl=new ChatClientCtrl(server);

        FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("login.fxml"));
        Parent root=loader.load();

        LoginController ctrl = loader.getController();
        ctrl.init(clientCtrl);
        stage.setScene(new Scene(root));
        stage.show();
